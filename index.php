...
<div class="hidden-xs visible-sm visible-md visible-lg" id="videoBlock" style="width: 100%; height: 500px;"
     data-vide-bg="video/ocean"
     data-vide-options="position: 0% 50%">
    <div id="videoOver"><h1>Notre diversité fait notre unité</h1>
        <div class="videoTitleDeco"></div>
        <h3>Le Doge Club, fédérateur des entreprises du numérique</h3>
    </div>
</div>

<div class="xs-bg visible-xs hidden-sm hidden-md hidden-lg">
    <div id="videoOverXs" class="mobilevideo"><h1>Notre diversité fait notre unité</h1>
        <div class="videoTitleDeco"></div>
        <h3>Le Doge Club, fédérateur des entreprises du numérique</h3>
    </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 indexNews">
                ...
                <h3>
                    <a href="news.php">La société Ak 10 arrive dans nos locaux</a>
                </h3>
            ...
            <div class="col-md-4 indexNews">
                ...
                <h3>
                    <a href="news.php">Retour sur l'apéro du 12 Septembre 2016</a>
                </h3>
